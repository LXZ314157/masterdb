...
public class ViewBuyerList {
    ...
    private String attrdeposit;

    private String dealerplatformflag;
     ...
     * @param attrdeposit
     */
    public void setAttrdeposit(String attrdeposit) {
        this.attrdeposit = attrdeposit;
    }

    /**
     * @return dealerplatformflag
     */
    public String getDealerplatformflag() {
        return dealerplatformflag;
    }

    /**
     * @param dealerplatformflag
     */
    public void setDealerplatformflag(String dealerplatformflag) {
        this.dealerplatformflag = dealerplatformflag;
    }
